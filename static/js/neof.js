...
function get_neo_feed(){
    ...
    start_init = start_date.value;
    end_init = end_date.value;

    var DateStartObj = new Date(start_init);
    var DateEndObj = new Date(end_init);
    ...
    var year0 = DateStartObj.getFullYear();
    var month0 = String(DateStartObj.getMonth() + 1).padStart(2, '0'); // Adjust month to 0-based index
    var day0 = String(DateStartObj.getDate()).padStart(2, '0');
    
    // Extract year, month, and day from the Date object
    var year1 = DateEndObj.getFullYear();
    var month1 = String(DateEndObj.getMonth() + 1).padStart(2, '0'); // Adjust month to 0-based index
    var day1 = String(DateEndObj.getDate()).padStart(2, '0');
    
    // Create the rearranged date string
    var start = `${year0}-${month0}-${day0}`;
